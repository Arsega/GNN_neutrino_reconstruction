...
BASE_PATH = "/mnt/ssd2/data/SouthPole/single_surface_4LPDA_PA_15m_RNOG_fullsim.json"
...
class Dataset:
    def __init__(self, dataset_name, em=False, noise=True):
        if dataset_name.upper() == "ALVAREZ":
            ...
            self.test_file_ids = [79,80,81,82]
            ...
            self.data_filename = f"data_1-3_LPDA_2of4_100Hz_4LPDA_1dipole_fullband_"
            self.label_filename = f"labels_1-3_LPDA_2of4_100Hz_4LPDA_1dipole_fullband_"
            self.n_files = 83
            self.n_files_val = 12
