...
run_id='direction_higher_20_files'
...
list_of_file_ids_train_small = np.random.choice(list_of_file_ids_train, size=25, replace=False)  # train_files
print("Picked training set ids:",list_of_file_ids_train_small)
list_of_file_ids_val_small = np.random.choice(list_of_file_ids_val, size=2, replace=False)  # val_files
...
class GCN(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = ReduceLROnPlateau(optimizer, 'min', factor=0.2, patience=es_patience-5, min_lr=0.000001, verbose=1)
